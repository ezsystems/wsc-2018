...
class Type extends FieldType implements Nameable
{
     ...
     *
     * @param array|\AppBundle\eZ\Publish\FieldType\Poll\Value $inputValue
     *
     * @return \AppBundle\eZ\Publish\FieldType\Poll\Value The potentially converted and structurally plausible value.
     */
     ...
     *
     * @param \AppBundle\eZ\Publish\FieldType\Poll\Value $value
     */
     ...
     *
     * @return \AppBundle\eZ\Publish\FieldType\Poll\Value
     */

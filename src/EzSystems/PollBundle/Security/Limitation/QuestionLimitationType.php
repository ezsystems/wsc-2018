...
namespace EzSystems\PollBundle\Security\Limitation;
...
/**
 * QuestionLimitation is a Poll limitation.
 */
class QuestionLimitationType extends AbstractPersistenceLimitationType implements SPILimitationTypeInterface
{
    /**
    ...
    {
        if (!$limitationValue instanceof QuestionLimitation) {
            throw new InvalidArgumentType('$limitationValue', 'QuestionLimitation', $limitationValue);
    ...
    public function validate(APILimitationValue $limitationValue)
    {
        ...
        foreach ($limitationValue->limitationValues as $key => $value) {
            try {
                $this->persistence->contentHandler()->loadContentInfo($value);
    ...
    {
        return new QuestionLimitation(array('limitationValues' => $limitationValues));
    }
    ...
    {
        if (!$value instanceof QuestionLimitation) {
            throw new InvalidArgumentException('$value', 'Must be of type: QuestionLimitation');
        }
